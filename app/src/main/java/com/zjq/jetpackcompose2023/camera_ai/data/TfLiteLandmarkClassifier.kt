package com.zjq.jetpackcompose2023.camera_ai.data
...
class TfLiteLandmarkClassifier(
    ...
    override fun classify(bitmap: Bitmap, orientation: Int): List<Classification> {
        if (classifier == null) {
            setupClassifier()
        }
        ...
        val imageProcessingOptions = ImageProcessingOptions.builder()
            .setOrientation(getOrientationFromRotation(orientation))
            .build()
